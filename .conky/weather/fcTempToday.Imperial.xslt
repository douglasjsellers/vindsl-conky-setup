...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0" >
  ...
  <xsl:template match="forecast">
    ...
    <xsl:value-of select="simpleforecast/forecastdays/forecastday/high/fahrenheit" /><!-- Fetches today's high temp -->
    ...
    <xsl:value-of select="simpleforecast/forecastdays/forecastday/low/fahrenheit" /><!-- Fetches today's low temp -->
    <xsl:text>ºF</xsl:text><!-- F (for Fahrenheit) -->
  </xsl:template>
</xsl:stylesheet>
